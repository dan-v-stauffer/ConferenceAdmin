<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="RegisterExtStaff.aspx.cs" Inherits="RegisterExtStaff" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up_Body" UpdateMode="Conditional" runat="server" ChildrenAsTriggers="false">
        <ContentTemplate>
<%--            <asp:UpdatePanel ID="up_SelectStaff" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
--%>                    <asp:Panel runat="server" ID="pnl_SelectStaff" Width="1075" Style="margin-top: 10px;
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float: left; margin-right: 10px">
                                        <h2>
                                            Select External Staff Member:</h2>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <tr>
                                    ...
                                    <td class="rsvpForm_LeftColumn" style="padding-top: 30px">
                                        <asp:DropDownList ID="ddl_VendorSelect" Width="225" CssClass="input" runat="server"
                                           >
                                        </asp:DropDownList>
                                        <asp:CascadingDropDown ID="cascex_Venues" runat="server" TargetControlID="ddl_VendorSelect"
                                            Category="VendorID" PromptText="Select Vendor:" ServicePath="~/ConferenceWebService.asmx"
                                            ServiceMethod="GetConferenceVendors" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="rsvpForm_LeftColumn" style="padding-top: 30px">
                                        Select Staff Mbr:</span>:
                                    </td>
                                    <td class="rsvpForm_RightColumn">
                                        <asp:DropDownList ID="ddl_ExtStaffSelect" Width="225" CssClass="input" runat="server" AutoPostBack="true"
                                        OnSelectedIndexChanged="ddl_ExtStaffSelect_SelectedIndexChanged" >
                                        </asp:DropDownList>
                                        <asp:CascadingDropDown ID="cascex_VenueSpaces" runat="server" TargetControlID="ddl_ExtStaffSelect"
                                            Category="UserEmail" PromptText="Select Staff Member:" ParentControlID="ddl_VendorSelect"
                                            ServicePath="~/ConferenceWebService.asmx" ServiceMethod="GetVendorStaffMembers" />
                                    </td>
                                </tr>
                        </table>
                    </asp:Panel>
...
--%>            <asp:Panel runat="server" ID="rsvp_form" Width="1075" Style="margin-top: 10px; border: 1px solid silver;">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="rsvpForm_RightColumn">
                        <asp:UpdatePanel ID="up_StaffRole" runat="server">
                                                <ContentTemplate>
                            <asp:TextBox ID="tb_StaffRole" CssClass="input" runat="server" Width="250" ClientIDMode="Static"
                    ...
                    <tr>
                        ...
                        <td class="rsvpForm_RightColumn">
                            <asp:UpdatePanel runat="server" ID="up_Transportation" UpdateMode="Conditional">
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="ddl_ExtStaffSelect" EventName="SelectedIndexChanged" />
