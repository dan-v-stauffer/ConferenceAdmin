<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="ManageAttendee.aspx.cs" Inherits="ManageAttendee" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainContent">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="rsvpForm_RightColumn">
                            <asp:Label ID="lbl_RSVPType" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="rsvpForm_LeftColumn" style="padding-top: 30px">
                        ...
                        <td class="rsvpForm_RightColumn">
                            <div style="float: left; width: 800px">
                                ...
                                <asp:RequiredFieldValidator ID="val_Name" runat="server" InitialValue="" Display="Dynamic"
                                    CssClass="validationMsg" ControlToValidate="tb_FirstName" ErrorMessage="Name*: This is a required field."></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td class="rsvpForm_LeftColumn" style="padding-top: 8px">
                            Speaker Collateral Info:
                        </td>
                        <td class="rsvpForm_RightColumn">
                            <asp:LinkButton ID="lb_SpeakerAddOn" runat="server">Add/Modify Collateral Information</asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td class="rsvpForm_LeftColumn" style="padding-top: 8px">
                        ...
                        <td class="rsvpForm_RightColumn">
                            ...
                            <div style="width: 100%">
                                <asp:RequiredFieldValidator ID="val_ShirtSize" runat="server" InitialValue="Please select:"
                                    ...
                                    ErrorMessage="Shirt Size*: This is a required field."></asp:RequiredFieldValidator>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="rsvpForm_RightColumn">
                            <asp:DataList ID="dl_SelectedEvents_Days" runat="server" RepeatDirection="Vertical"
                                OnItemDataBound="dl_SelectedEventDays_ItemDataBound">
                                <ItemTemplate>
                                    <b>
                                        <asp:Label ID="lbl_ConferenceDay" runat="server" Text="" /><br />
                                    </b>
                                    <asp:Label ID="lbl_SelectedEvents_NoData" runat="server" Text="No user-selected events on this date." />
                                    <asp:DataList ID="dl_SelectedEventParent" runat="server" RepeatDirection="Vertical"
                                        OnItemDataBound="dl_SelectedEventParent_ItemDataBound">
                                        <ItemTemplate>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:LinkButton ID="lb_AssignEvent" runat="server" Text="Assign" OnClick="lb_AssignEvent_Click" />
                                                                <asp:HiddenField ID="hdn_EventID" runat="server" Value="" />
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_EventTime" runat="server" />
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_EventName" runat="server" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        <td colspan="3" style="margin-left:15px">
                                                            <asp:RadioButtonList ID="rbl_ChildEvents" runat="server" 
                                                                RepeatDirection="Vertical" CssClass="hidden"
                                                                DataTextField="eventText" DataValueField="eventID" 
                                                                OnSelectedIndexChanged="rbl_ChildEvents_SelectedIndexChanged">
                                                            </asp:RadioButtonList>
                                                        </td>
                                                        </tr>
                                                    </table>
                    ...
                    <tr>
                        ...
                        <td class="rsvpForm_RightColumn">
                            <asp:DataList ID="dl_AssignEvent_Days" runat="server" RepeatDirection="Vertical">
                                <HeaderTemplate>
                                    <asp:LinkButton ID="lb_AssignEvents" runat="server" Text="Assign Event" OnClick="lb_AssignEvents_Click" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <b>
                                        <asp:Label ID="lbl_ConferenceDay" runat="server" Text="" /><br />
                                    ...
                                    <asp:Label ID="lbl_SelectedEvents_NoData" runat="server" Text="No user-selected events on this date." />
                                    <asp:DataList ID="dl_AssignedEvent" runat="server" RepeatDirection="Vertical">
                                        <ItemTemplate>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="lb_RemoveAssignedEvent" runat="server" OnClick="lb_RemoveAssignedEvent_Click"
                                                            Text="Remove" />
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="lbl_EventTime" runat="server" Text="" />
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="lbl_Role" runat="server" Text="" />
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="lbl_EventTitle" runat="server" Text="" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                </tr>
    ...
    <asp:Button ID="bn_ShowSpeakerAddOn" runat="server" Style="display: none" />
    <asp:ModalPopupExtender ID="modal_SpeakerAddOn" runat="server" TargetControlID="bn_ShowSpeakerAddOn"
        PopupControlID="pnl_SpeakerAddOnModal" BackgroundCssClass="modalBackground" />
    <asp:Panel ID="pnl_SpeakerAddOnModal" runat="server" Width="500px" BackColor="White"
        BorderColor="Navy" BorderStyle="Solid" BorderWidth="2" Style="display: none;
        padding: 10px 10px 10px 10px">
        <asp:UpdatePanel ID="up_SpeakerAddOnModal" runat="server">
            <ContentTemplate>
                <div id="div1" style="display: table">
                    <h2>
                        <asp:Label ID="lbl_SpeakerAddOnHeader" runat="server" Text="">Speaker Collateral Info</asp:Label></h2>
                    <div style="margin-top: 10px; margin-bottom: 5px; width: 95%">
                    ...
                    <table class="formTable">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tb_SpeakerPrefix" runat="server" Width="250" CssClass="floaterL"
                                    Text="" />
                                <div class="floaterL">
                                    (Mr., Mrs., Dr., Prof., etc.)</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="tb_Title" runat="server" Width="625" CssClass="floaterL" Text="" />
                                <div class="floaterL">
                                    (i.e. - Chief Engineering Officer, KLA-Tencor)</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="tb_Bio" runat="server" Width="625" CssClass="floaterL" Text="" TextMode="MultiLine" />
                                <div class="floaterL">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <img align="middle" alt="" src="Images/uploading.gif"/></asp:Label>
                                <asp:AjaxFileUpload ID="upload_SpeakerPhoto" runat="server" OnUploadComplete="upload_SpeakerPhoto_UploadComplete"
                                    ThrobberID="lbl_Throbber" MaximumNumberOfFiles="1" AllowedFileTypes="jpg,jpeg,gif,png,bmp" />
                                <
                            </td>
                        </tr>
                    </table>
                ...
                <div align="right" style="width: 95%; margin-top: 15px">
                    <asp:Button ID="bn_SuccessSpeakerAddOn" runat="server" Text="OK" Width="50px" OnClick="bn_SuccessSpeakerAddOn_Click"
                        CssClass="aspHoverButton" CausesValidation="false" />
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
