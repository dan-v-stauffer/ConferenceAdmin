<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConferenceConfirmation.aspx.cs"
    Inherits="ConferenceConfirmation" %>
                ...
                <tr>
                    <td valign="top">
                        <div style="width: 800px">
                            ...
                            <p><asp:Label ID="userFirstNameGreeting" runat="server"></asp:Label></p>
                                <p>
                                ...
                                <p>
                                    If your plans have changed and you need to cancel your conference reservation, please visit the Engineering
                                    <a href='http://chief-engineer/EngineeringConference/Registration/'>Conference Registration
                                        site</a> and click the red <span style="color: Red; font-weight:bold">'Decline'</span> button
                                    so we can release your room. Please send an email to the <a href="mailto:brandy@positively-events.com">Conference Coordinator, Brandy Batch</a>, so she
                                    may cancel your hotel reservation. </p>

                                <asp:Panel ID="pnl_OutofCA_Travellers" runat="server">
                                <p>
                                Attendees flying in for the event should make their way to KLA-Tencor on Sunday, 10/25 to utilize one of the shuttles. 
                                Departure from KT is at 3:00pm, 4:00pm and 5:00pm.  If those times do not fit your schedule please rent a car through 
                                the <a href='https://www.avis.com/car-rental/profile/go.ac?B460000' >KLA-Tencor portal</a>,  or book a seat on <a href='http://www.supershuttle.com/'>Super Shuttle</a>.
                                </p>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="rightColumn" style="width:700px">
                                        <asp:Label ID="lbl_HotelCheckin" CssClass="floaterL" runat="server" Text="Sunday, October 25 after 4:00PM" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="leftColumn" style="width: 200px; text-align: right; padding-right: 5px">
                    ...
                    <td valign="top" style="padding-left:25px">
                        <asp:Panel runat="server" ID="pnl_POC" Style="width: 225px; height: 225px; z-index: 1">
                            <asp:DataList ID="dl_ContactInfo" runat="server" >
                                <HeaderTemplate>
                                    <h2>
            ...
            <asp:Panel runat="server" ID="rsvp_form" Style="margin-top: 10px;">
                <table style="width: 1100px;">
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="padding-right: 5px; padding-left: 5px;">
                            <h2>
                                <b>Your Conference Schedule</b></h2>
                        </td>
                    </tr>
                    <tr>
                        <td class="rsvpForm_LeftColumn">
                        ...
                        <td class="rsvpForm_RightColumn">
                        <asp:DataList ID="dl_ConferenceDays" runat="server" OnItemDataBound="dl_ConferenceDays_ItemDataBound" >
                        <ItemTemplate>
                          <table>
                                <tr>
                                    <td valign="top" ><h3>
                                        <asp:Label ID="lbl_conferenceDay" runat="server" Text="" Font-Bold="true" /></h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                         <asp:DataList ID="dl_DaysEvents" runat="server" OnItemDataBound="dl_DaysEvents_ItemDataBound">
                                            <ItemTemplate>
                                                <table>
                                                <tr>
                                                   <td valign="top" style="padding-top:3px; width:100px"> <asp:Label ID="lbl_eventTime" runat="server" Width="100" Text="" /> </td>
                                                    <td valign="top" style="padding-left:5px; padding-top:3px"> <asp:Label ID="lbl_eventTitle" runat="server" Text="" /> </td>
                                                </tr>
                                                </table>
                                            </ItemTemplate>
                                        </asp:DataList>            
